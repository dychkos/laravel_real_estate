        ...
        <div class="card-body">
            ...
            <table id="houses_table" class="display" style="width:100%">
                ...
                @foreach($houses as $house)
                    <tr>
                        <td><input type="text"  id="row-1-age" name="{{"house-".$house->id."-name"}}" value="{{$house->name}}"></td>
                        <td><input type="text"   id="row-1-age"  name="{{"house-".$house->id."-price"}}" value="{{$house->price}}"></td>
                        <td>{{$house->address}}</td>
